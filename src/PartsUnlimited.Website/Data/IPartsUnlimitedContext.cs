...
namespace PartsUnlimited.Data
{
    ...
    {
        // Currently, there is no IDbSet<T> as there was in previous EF frameworks.  
        // Hopefully, one is added (see issue: https://github.com/aspnet/EntityFramework/issues/1282).
