...
namespace PartsUnlimited.Models
{
    public static class SampleData
    {
        ...
        /// <summary>
        /// Insert test data into the PartsUnlimited database
        /// </summary>
       ...
       private static IConfigurationSection GetAdminRoleConfiguration(IServiceProvider serviceProvider)
        ...
        /// <summary>
        /// Generate an enumeration of rainchecks.  
        /// The random number generator uses a seed to ensure that the sequence is consistent, but provides somewhat random looking data.
        /// </summary>
        private static IEnumerable<Raincheck> GetRainchecks(IEnumerable<Store> stores, IList<Product> products)
        {
        ...
        private static void PopulateOrderHistory(IServiceProvider serviceProvider, IEnumerable<Product> products)
        {
            var random = new Random(1234);
        ...
        private static OrderDetail GetOrderDetail(Product product, Order order)
        {
        ...
        private static IEnumerable<Product> GetProducts(IEnumerable<Category> categories)
        {
